...
namespace NETNENNET
{
    public partial class frmQUANLYPHONG : Form
    {
        ...
        private void Load_DataGridView()
        {
            ...
            string sql;
            sql = "SELECT Maphong, mamay, maocung, maram, machip, mamanhinh, macomanhinh, mabanphim, machuot, maloa, tinhtrang = CASE WHEN TinhTrang = 'true' THEN 1 ELSE 0 END , tinhtrangthue, ghichu FROM tblMaytinh";
        ...
        private void txtTinhtrang_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if ((Convert.ToInt32(e.KeyChar) == 8) || (Convert.ToInt32(e.KeyChar) == 13))
            {
                e.Handled = false;
            }
            else
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblMaytinh SET " +
                  ...
                  "WHERE MaPhong=N'" + cboMaphong.SelectedValue.ToString() + "' " +
                  "AND MaMay=N'" + txtMamay.Text + "'"; 
        ...
        private void dgvQuanlymay_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
